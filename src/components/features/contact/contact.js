...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_r4et5qs',
         'template_tss256s',
          form.current, {
          publicKey: '2Nx2eciysbPZ1pWwn',
        })
        .then(
          () => {
            console.log('SUCCESS!');
...
<p>git hub 
      ...
      <div className='div1'><form ref={form} onSubmit={sendEmail}
      className=" form-m">
      <label>Name</label>
